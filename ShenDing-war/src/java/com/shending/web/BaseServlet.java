...
import com.shending.support.NoPermException;
...
import com.shending.web.support.PostResult;
...
public abstract class BaseServlet extends HttpServlet {
    ...
    void setHttpOnlyCookieValue(HttpServletRequest request, HttpServletResponse response, String cname, String cvalue) {
        Cookie cookie = new Cookie(cname, cvalue);
        cookie.setPath("/");
...
//        }
    ...
    SysUser getSysUserFromSessionNoException(HttpServletRequest request) {
        HttpSession session = request.getSession();
        SysUser admin = (SysUser) session.getAttribute(SESSION_ATTRIBUTE_USER);
        return admin;
    }
