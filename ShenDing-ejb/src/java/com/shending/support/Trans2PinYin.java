...
public class Trans2PinYin {
    ...
    public static String trans2PinYinFirst(String str) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < str.length(); i++) {
            String s = Trans2PinYin.getInstance().convertAll(str.substring(i, i + 1));
            s = s.trim();
    ...
    public static void main(String[] args) {
        ...
        String strPinYin = trans2PinYinFirst(str);
